...
app.get('/displaytembylatlon', (req, res)=>{
    res.sendFile(__dirname+"/index.html");
})
app.post("/displaytembylatlon", (req,res)=>{
    const lat = req.body.lat;
    const lon = req.body.lon;
    const url = 'https://api.openweathermap.org/data/2.5/weather?lat='+lat+'&lon='+lon+'&appid=7dc1b69f400c5398ee5a129bb7764c93&units=metric&lang=th';
